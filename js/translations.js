...
const translations = {
    pt: {
        ...
        presentation: {
            ...
            processo_osint: "Processo de OSINT",
            coleta_dados: "Coleta de Dados",
            enriquecimento: "Enriquecimento & QC",
            analise_ia: "Análise com IA",
            visualizacao: "Visualização de Insights",
            integracao: "Integração de Plataformas",
            etica: "Considerações Éticas",
            lgpd: "LGPD & Conformidade Legal",
            ferramentas: "Ferramentas & Arquitetura",
            casos_uso: "Casos de Uso Práticos",
            estrategias: "Estratégias de Melhores Práticas",
            roadmap: "Roadmap Futuro",
            desafios: "Desafios & Lições Aprendidas",
            ...
            coleta_dados_content: "A fase inicial envolve a identificação e coleta de dados de múltiplas fontes: redes sociais, sites, documentos públicos, bases de dados abertas, registros governamentais, fóruns e muito mais. Ferramentas especializadas permitem extrações sistemáticas respeitando termos de uso.",
            enriquecimento_content: "Os dados brutos passam por processos de limpeza, normalização e enriquecimento. Sistemas de Quality Control verificam precisão, completude e relevância. Aqui, algoritmos de IA começam a identificar correlações preliminares entre diferentes conjuntos de dados.",
            analise_ia_content: "Algoritmos de Machine Learning e Deep Learning identificam padrões, anomalias e tendências invisíveis ao olho humano. Técnicas de NLP extraem significado de textos, enquanto sistemas de reconhecimento visual processam imagens e vídeos, criando conexões multidimensionais.",
            visualizacao_content: "Dashboards interativos, gráficos de relacionamento e mapas geoespaciais transformam dados complexos em visualizações intuitivas. A apresentação eficaz dos insights é crucial para que tomadores de decisão possam compreender rapidamente informações estratégicas.",
            integracao_content: "Sistemas modernos de OSINT se integram com plataformas corporativas existentes (CRM, ERP, BI) criando fluxos contínuos de inteligência. APIs, webhooks e microserviços permitem uma arquitetura flexível e adaptável às necessidades específicas de cada organização.",
            etica_content: "O poder do OSINT exige responsabilidade. Discutimos o delicado equilíbrio entre segurança e privacidade, os riscos de vigilância excessiva, vieses algorítmicos e a importância de frameworks éticos sólidos para guiar práticas responsáveis de coleta e análise.",
            lgpd_content: "No Brasil, a LGPD estabelece limites claros para o tratamento de dados pessoais, mesmo quando publicamente acessíveis. Analisamos os fundamentos legais para OSINT, especialmente legítimo interesse, e as salvaguardas necessárias para práticas em conformidade.",
            ferramentas_content: "Um ecossistema completo de ferramentas suporta profissionais modernos de OSINT: plataformas de coleta como Maltego, sistemas de análise como IBM i2, e frameworks de código aberto como OSINT Framework, SpiderFoot e aplicações específicas para domínios verticais.",
            casos_uso_content: "OSINT potencializado por IA tem transformado setores diversos: anticorrupção corporativa, due diligence em fusões e aquisições, monitoramento de riscos reputacionais, proteção de propriedade intelectual, análise competitiva e detecção de fraudes.",
            estrategias_content: "Para resultados consistentes: desenvolva playbooks específicos para casos de uso recorrentes, defina critérios claros de qualidade de dados, estabeleça ciclos de feedback contínuo, e mantenha balanceamento entre automação e supervisão humana.",
            roadmap_content: "Tendências emergentes incluem: análise multimodal (texto, imagem, áudio, vídeo), Large Language Models para relatórios automatizados, sistemas de OSINT com capacidades preditivas, e ferramentas de IA generativa para simulação de cenários e análise de impacto.",
            desafios_content: "Os principais desafios incluem: equilibrar automação e julgamento humano, combater desinformação e deep fakes, manter conformidade regulatória em cenário dinâmico, e desenvolver métricas efetivas para quantificar o valor da inteligência produzida.",
            perguntas_content: "Momento para explorar tópicos específicos, casos de uso particulares e esclarecer dúvidas sobre implementações práticas. Compartilhe sua experiência e desafios para enriquecer a discussão coletiva.",
            proximos_passos_content: "Recursos para aprofundamento: comunidades especializadas, cursos e certificações, eventos e conferências, e oportunidades de networking com profissionais da área. O caminho para excelência em OSINT é contínuo e colaborativo.",
            obrigado_content: "Agradecemos sua participação! Para continuar a conversa ou explorar oportunidades de colaboração, entre em contato pelos canais abaixo. A jornada no universo de OSINT e IA está apenas começando – vamos construí-la juntos."
        }
    },
    en: {
        common: {
        ...
        presentation: {
            ...
            processo_osint: "OSINT Process",
            coleta_dados: "Data Collection",
            enriquecimento: "Enrichment & QC",
            analise_ia: "AI Analysis",
            visualizacao: "Insights Visualization",
            integracao: "Platform Integration",
            etica: "Ethical Considerations",
            lgpd: "GDPR & Legal Compliance",
            ferramentas: "Tools & Architecture",
            casos_uso: "Practical Use Cases",
            estrategias: "Best Practice Strategies",
            roadmap: "Future Roadmap",
            desafios: "Challenges & Lessons Learned",
            ...
            coleta_dados_content: "The initial phase involves identifying and collecting data from multiple sources: social networks, websites, public documents, open databases, government records, forums and more. Specialized tools allow systematic extractions while respecting terms of use.",
            enriquecimento_content: "Raw data undergoes cleaning, normalization and enrichment processes. Quality Control systems verify accuracy, completeness and relevance. Here, AI algorithms begin to identify preliminary correlations between different data sets.",
            analise_ia_content: "Machine Learning and Deep Learning algorithms identify patterns, anomalies and trends invisible to the human eye. NLP techniques extract meaning from text, while visual recognition systems process images and videos, creating multidimensional connections.",
            visualizacao_content: "Interactive dashboards, relationship graphs and geospatial maps transform complex data into intuitive visualizations. Effective presentation of insights is crucial for decision makers to quickly understand strategic information.",
            integracao_content: "Modern OSINT systems integrate with existing corporate platforms (CRM, ERP, BI) creating continuous intelligence flows. APIs, webhooks and microservices allow for a flexible architecture adaptable to each organization's specific needs.",
            etica_content: "The power of OSINT requires responsibility. We discuss the delicate balance between security and privacy, the risks of excessive surveillance, algorithmic biases and the importance of solid ethical frameworks to guide responsible collection and analysis practices.",
            lgpd_content: "In Brazil, LGPD establishes clear limits for the processing of personal data, even when publicly accessible. We analyze the legal foundations for OSINT, especially legitimate interest, and the necessary safeguards for compliant practices.",
            ferramentas_content: "A complete ecosystem of tools supports modern OSINT professionals: collection platforms like Maltego, analysis systems like IBM i2, and open source frameworks like OSINT Framework, SpiderFoot and specific applications for vertical domains.",
            casos_uso_content: "AI-powered OSINT has transformed diverse sectors: corporate anti-corruption, due diligence in mergers and acquisitions, reputational risk monitoring, intellectual property protection, competitive analysis and fraud detection.",
            estrategias_content: "For consistent results: develop specific playbooks for recurring use cases, define clear data quality criteria, establish continuous feedback cycles, and maintain balance between automation and human supervision.",
            roadmap_content: "Emerging trends include: multimodal analysis (text, image, audio, video), Large Language Models for automated reports, OSINT systems with predictive capabilities, and generative AI tools for scenario simulation and impact analysis.",
            desafios_content: "Key challenges include: balancing automation and human judgment, combating disinformation and deep fakes, maintaining regulatory compliance in a dynamic landscape, and developing effective metrics to quantify the value of intelligence produced.",
            perguntas_content: "Time to explore specific topics, particular use cases and clarify doubts about practical implementations. Share your experience and challenges to enrich the collective discussion.",
            proximos_passos_content: "Resources for deeper learning: specialized communities, courses and certifications, events and conferences, and networking opportunities with professionals in the field. The path to excellence in OSINT is continuous and collaborative.",
            obrigado_content: "We appreciate your participation! To continue the conversation or explore collaboration opportunities, contact us through the channels below. The journey in the universe of OSINT and AI is just beginning - let's build it together."
        }
    },
    es: {
        common: {
        ...
        presentation: {
            ...
            processo_osint: "Proceso de OSINT",
            coleta_dados: "Recolección de Datos",
            enriquecimento: "Enriquecimiento & QC",
            analise_ia: "Análisis con IA",
            visualizacao: "Visualización de Insights",
            integracao: "Integración de Plataformas",
            etica: "Consideraciones Éticas",
            lgpd: "LGPD & Conformidad Legal",
            ferramentas: "Herramientas & Arquitectura",
            casos_uso: "Casos de Uso Prácticos",
            estrategias: "Estrategias de Mejores Prácticas",
            roadmap: "Roadmap Futuro",
            desafios: "Desafíos & Lecciones Aprendidas",
            ...
            coleta_dados_content: "La fase inicial involucra la identificación y recolección de datos de múltiples fuentes: redes sociales, sitios web, documentos públicos, bases de datos abiertas, registros gubernamentales, foros y más. Herramientas especializadas permiten extracciones sistemáticas respetando términos de uso.",
            enriquecimento_content: "Los datos crudos pasan por procesos de limpieza, normalización y enriquecimiento. Sistemas de Control de Calidad verifican precisión, completitud y relevancia. Aquí, algoritmos de IA comienzan a identificar correlaciones preliminares entre diferentes conjuntos de datos.",
            analise_ia_content: "Algoritmos de Machine Learning y Deep Learning identifican patrones, anomalías y tendencias invisibles al ojo humano. Técnicas de NLP extraen significado de textos, mientras sistemas de reconocimiento visual procesan imágenes y videos, creando conexiones multidimensionales.",
            visualizacao_content: "Dashboards interactivos, gráficos de relación y mapas geoespaciales transforman datos complejos en visualizaciones intuitivas. La presentación eficaz de los insights es crucial para que los tomadores de decisiones puedan comprender rápidamente información estratégica.",
            integracao_content: "Sistemas modernos de OSINT se integran con plataformas corporativas existentes (CRM, ERP, BI) creando flujos continuos de inteligencia. APIs, webhooks y microservicios permiten una arquitectura flexible y adaptable a las necesidades específicas de cada organización.",
            etica_content: "El poder del OSINT exige responsabilidad. Discutimos el delicado equilibrio entre seguridad y privacidad, los riesgos de vigilancia excesiva, sesgos algorítmicos y la importancia de marcos éticos sólidos para guiar prácticas responsables de recolección y análisis.",
            lgpd_content: "En Brasil, la LGPD establece límites claros para el tratamiento de datos personales, incluso cuando son públicamente accesibles. Analizamos los fundamentos legales para OSINT, especialmente el interés legítimo, y las salvaguardas necesarias para prácticas en conformidad.",
            ferramentas_content: "Un ecosistema completo de herramientas apoya a profesionales modernos de OSINT: plataformas de recolección como Maltego, sistemas de análisis como IBM i2, y frameworks de código abierto como OSINT Framework, SpiderFoot y aplicaciones específicas para dominios verticales.",
            casos_uso_content: "OSINT potenciado por IA ha transformado sectores diversos: anticorrupción corporativa, due diligence en fusiones y adquisiciones, monitoreo de riesgos reputacionales, protección de propiedad intelectual, análisis competitivo y detección de fraudes.",
            estrategias_content: "Para resultados consistentes: desarrolle playbooks específicos para casos de uso recurrentes, defina criterios claros de calidad de datos, establezca ciclos de retroalimentación continua, y mantenga balance entre automatización y supervisión humana.",
            roadmap_content: "Tendencias emergentes incluyen: análisis multimodal (texto, imagen, audio, video), Modelos de Lenguaje Grande para informes automatizados, sistemas de OSINT con capacidades predictivas, y herramientas de IA generativa para simulación de escenarios y análisis de impacto.",
            desafios_content: "Los principales desafíos incluyen: equilibrar automatización y juicio humano, combatir desinformación y deep fakes, mantener conformidad regulatoria en escenario dinámico, y desarrollar métricas efectivas para cuantificar el valor de la inteligencia producida.",
            perguntas_content: "Momento para explorar tópicos específicos, casos de uso particulares y aclarar dudas sobre implementaciones prácticas. Comparta su experiencia y desafíos para enriquecer la discusión colectiva.",
            proximos_passos_content: "Recursos para profundización: comunidades especializadas, cursos y certificaciones, eventos y conferencias, y oportunidades de networking con profesionales del área. El camino hacia la excelencia en OSINT es continuo y colaborativo.",
            obrigado_content: "¡Agradecemos su participación! Para continuar la conversación o explorar oportunidades de colaboración, contáctenos a través de los canales a continuación. El viaje en el universo de OSINT e IA está apenas comenzando – construyámoslo juntos."
        }
    }
};
